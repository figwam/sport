...
DELETE FROM partner;
DELETE FROM trainee_password_info;
DELETE FROM trainee_login_info;
DELETE FROM trainee;
DELETE FROM address;
...
select setval('trainee_id_seq',1);
select setval('studio_id_seq',1);
select setval('login_info_id_seq',1);
select setval('partner_password_info_id_seq',1);
select setval('trainee_password_info_id_seq',1);
select setval('registration_id_seq',1);
select setval('clazz_id_seq',1);
...
--VALUES (uuid_generate_v1(),'2015-09-28 17:00:00.000000','2016-09-28 17:45:00.000000','Sandsack',5,2),
--	(uuid_generate_v1(),'2015-09-25 16:00:00.000000','2015-09-25 17:30:00.000000','Fitness',3,3),
--	(uuid_generate_v1(),'2015-10-8 14:00:00.000000','2015-10-08 15:00:00.000000','Calistenics 4 All',20,4);
...
Insert INTO registration (ext_id, id_trainee, id_clazz) VALUES
	...
	(uuid_generate_v1(),3,2),
	(uuid_generate_v1(),4,2),
	(uuid_generate_v1(),4,3);
